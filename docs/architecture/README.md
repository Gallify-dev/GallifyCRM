...
| `agency-workspaces.architecture.json` | agência v0 — organização pai, N filhos isolados pela membership, modelo que copia funil, rascunho de agente e tipo de compromisso; sem canal e sem cobrança |
